...
public class TakeQuizServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<AnswerDTO> listAns = (ArrayList<AnswerDTO>) session.getAttribute("LISTANSWER");
        ...
        try {
            ...
            String id_ques = request.getParameter("txtQuestion");
            hisdetailDAO.updateUserAnser(user_choice, Integer.parseInt(id_his), Integer.parseInt(id_ques));
            session.setAttribute("ANSWER_CHOOSE", user_choice);
